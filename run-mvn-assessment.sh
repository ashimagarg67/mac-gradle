...
log_and_execute mvn "$QUIET" org.cyclonedx:cyclonedx-maven-plugin:$PLUGIN_VERSION:makeAggregateBom -DoutputDirectory=$directory -DoutputName=\$\{project.artifactId\} -Dcyclonedx.skipAttach=true -Dcyclonedx.skipNotDeployed=false -DoutputFormat=json
progress_bar 80
